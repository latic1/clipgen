    ...
    try {
      ...
      if (result.success) {
        toast.success("S3 Configuration Test", {
          description: "S3 configuration is working correctly.",
        });
      } else {
        toast.error("S3 Configuration Test Failed", {
    ...
    try {
      ...
      try {
        ...
        if (!uploadResponse.ok) {
          ...
          if (uploadResponse.status === 403) {
            errorMessage = "Access denied to storage. Please check your permissions.";
        ...
        console.log("Uploaded file ID received", uploadedFileId);
        ...
        if (uploadError instanceof Error) {
          ...
          if (uploadError.message.includes('ERR_CONNECTION_ABORTED') || uploadError.message.includes('Failed to fetch')) {
      ...
      if (error instanceof Error) {
        if (error.message.includes("timed out")) {
          ...
          errorMessage = "Upload was interrupted. Please check your internet connection and try again.";
    ...
    <div className="mx-auto flex max-w-5xl flex-col space-y-6 px-4 py-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <Button variant="outline" onClick={testS3Config}>
            Test S3 Config
          </Button>
